...
const ble_uuid128_t sensor_svc_uuid = BLE_UUID128_INIT(
    0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12, 0xcd, 0xab, 0x34, 0x12, 0xcd, 0xab, 0x01, 0xff, 0x00, 0x00);

// Characteristic ("file")
// 00 00 ff 01 ab cd 12 34 ab cd 12 34 56 78 9a bc
const ble_uuid128_t sensor_chr_uuid = BLE_UUID128_INIT(
    0xbc, 0x9a, 0x78, 0x56, 0x34, 0x12, 0xcd, 0xab, 0x34, 0x12, 0xcd, 0xab, 0x02, 0xff, 0x00, 0x00);

// GATT Table Definition (Test)
...
const struct ble_gatt_svc_def gatt_svcs[] = {
    {.type = BLE_GATT_SVC_TYPE_PRIMARY,
     ...
     .characteristics =
         (struct ble_gatt_chr_def[]){{.uuid = &sensor_chr_uuid.u,
