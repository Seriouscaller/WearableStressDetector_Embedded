...
#define MAX30101_ENABLE_PIN 2

// Adds sensor to i2c
// Configure device
esp_err_t max30101_init(i2c_master_bus_handle_t bus_handle, i2c_master_dev_handle_t *max_handle)
{
    gpio_reset_pin(MAX30101_ENABLE_PIN);
    gpio_set_direction(MAX30101_ENABLE_PIN, GPIO_MODE_OUTPUT);
    gpio_set_level(MAX30101_ENABLE_PIN, 1);
